...
<?php $__env->startSection('content'); ?>
    ...
    <section class="hero-section hero-section--video" id="home">
        <video class="hero-video" autoplay muted loop playsinline poster="<?php echo e(asset('Morningstar.logo.jpg')); ?>" aria-hidden="true">
            <source src="<?php echo e(asset('videos/Video.m4v')); ?>" type="video/mp4">
        </video>
        <div class="container">
