            ...
            <div class="row align-items-center">
                <div class="col-lg-7 hero-content" data-aos="fade-up">
                    ...
                    <div class="hero-buttons">
                        ...
                        <a href="<?php echo e(route('contact')); ?>" class="btn-secondary-custom">
                ...
                <div class="col-lg-5" data-aos="fade-left">
                    <?php if($heroImages->isNotEmpty()): ?>
                        <img src="<?php echo e(asset('storage/' . $heroImages->first()->image_path)); ?>" alt="Printing Press" class="img-fluid rounded-lg" style="box-shadow: 0 20px 40px rgba(0,0,0,0.2);">
                    <?php else: ?>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                        <div class="service-card">
                            <?php if($service->image): ?>
                                <img src="<?php echo e(asset('storage/' . $service->image)); ?>" alt="<?php echo e($service->name); ?>" class="img-fluid rounded mb-3" style="height: 200px; object-fit: cover;">
                            <?php elseif($service->icon): ?>
                                <i class="fas <?php echo e($service->icon); ?> mb-3"></i>
                            <?php else: ?>
                                <i class="fas fa-star mb-3"></i>
                            <?php endif; ?>
                            <h3><?php echo e($service->name); ?></h3>
                            <p><?php echo e(Str::limit($service->description, 100)); ?></p>
                            <a href="<?php echo e(route('service.show', $service->slug)); ?>" class="btn-primary-custom" style="font-size: 0.9rem; padding: 8px 20px;">View Details</a>
                        </div>
                    </div>
    ...
    <section class="section-padding" style="background: linear-gradient(135deg, #f8f9fa 0%, #e8eaef 100%);">
        <div class="container">
            <div class="text-center" data-aos="fade-up">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="btn-primary-custom" style="font-size: 1.1rem; padding: 15px 40px;">
